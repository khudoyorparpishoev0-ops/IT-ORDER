...
const SAMPLE: RequestDetail = {
  ...
  events: [
    { kind: 'created', text: 'Черновик создан', actor: 'Иван Петров', actor_type: 'human', actor_id: 1, actor_role: 'employee', details: {}, meta: 'ИВАН ПЕТРОВ · 01.09.2026, 09:40', created_at: '2026-09-01T04:40:00Z' },
    { kind: 'submitted', text: 'Отправлена на согласование', actor: 'Иван Петров', actor_type: 'human', actor_id: 1, actor_role: 'employee', details: { status: { from: 'draft', to: 'pending' }, holder: 'У руководителя: согласовать покупку' }, meta: 'ИВАН ПЕТРОВ · 01.09.2026, 09:52', created_at: '2026-09-01T04:52:00Z' },
    { kind: 'sourcing', text: 'Покупка согласована, передана в закуп', actor: 'Мария Сидорова', actor_type: 'human', actor_id: 2, actor_role: 'manager', details: { status: { from: 'pending', to: 'sourcing' }, holder: 'У отдела закупа: склад и цены' }, meta: 'МАРИЯ СИДОРОВА · 04.09.2026, 18:12', created_at: '2026-09-04T13:12:00Z' },
  ],
  payment: null,
...
const REJECTED: RequestDetail = {
  ...
  events: [
    ...
    { kind: 'rejected', text: 'Отклонена — превышение бюджета объекта', actor: 'Мария Сидорова', actor_type: 'human', actor_id: 2, actor_role: 'manager', details: { status: { from: 'pending', to: 'rejected' }, comment: 'Превышение бюджета объекта' }, meta: 'МАРИЯ СИДОРОВА · 05.09.2026, 10:02', created_at: '2026-09-05T05:02:00Z' },
  ],
};
